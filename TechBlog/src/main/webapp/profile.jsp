...
<body>
			...
			<div class="row mt-4">
				...
				<div class="col-md-4">
					...
					<div class="list-group">
 						 ...
 						 <!-- Categories coming from getAllCategories method -->
 						 <% 
				...
				<div class="col-md-8">
					...
					<div class="contaier-fluid" id="post-container">
	...
	<script>
	 ...
	 <script>
	 	function getPosts(catId, temp){//temp stores the reference to the link which is clicked
	 		$("#loader").show();
	 		$("#post-container").hide();
	 		$(".c-link").removeClass('active');//sari classes sa active class hata di
